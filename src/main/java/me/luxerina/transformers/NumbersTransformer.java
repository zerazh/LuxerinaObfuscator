...
import me.luxerina.utils.NodeUtils;

public class NumbersTransformer extends Transformer {
	
	public NumbersTransformer(Obfuscator obf) {
		super(obf);
	}
	...
	public void visit(ClassNode classNode) {
		...
		String MNAME = NameGen.load() + NameGen.String(50);
		String desc = "(III)I";
		int xor = RANDOM.nextInt();
		String FNAME1 = NameGen.String(50);
